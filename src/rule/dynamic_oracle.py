...
if __name__ == '__main__':
    ...
    correct = [Root1(3), Root(3), Sel(0), N(0), Filter(0), Filter(0), Filter(2), Root(3), Sel(0), N(0), Filter(2), Filter(2)]
    # predicted_s = 'Root1(3) Root(4) Sel(0) N(2) A(0) C(4)'.split()
    predicted = [Root1(3), Root(3), Sel(0), N(0), Filter(0), Filter(2), Filter(2), Root(3), Sel(0), N(0), Filter(0)]
    print(predicted)
    print(correct)
